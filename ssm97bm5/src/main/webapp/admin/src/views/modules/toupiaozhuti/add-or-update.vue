<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="投票主题" prop="toupiaozhuti">
          <el-input v-model="ruleForm.toupiaozhuti" 
              placeholder="投票主题" clearable  :readonly="ro.toupiaozhuti"></el-input>
        </el-form-item>
        <div v-else>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `toupiaozhuti/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.toupiaozhutiCrossAddOrUpdateFlag = false;
						 this.parent.search();
